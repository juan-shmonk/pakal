  ...
  <div class="container">
    <div class="header__top">
      ...
      <nav class="header__catalog-nav" aria-label="Catálogos">
        <a href="/proyecto/index.php"<?= catClass('hombre', $activeCat) ?>>Hombre</a>
      ...
      <div class="header__actions">
        <?php if ($logueado): ?>
          ...
          <div class="header__user-menu">
            <a href="/proyecto/mi-cuenta.php" class="header__user-btn">
  ...
  <nav class="main-nav" aria-label="Navegación principal">
    <div class="container">
      <div class="main-nav__inner">
        ...
        <a href="/proyecto/productos.php?cat=ropa"<?= navClass('ropa', $activeNav) ?>>Ropa</a>
        <a href="/proyecto/productos.php?cat=zapatos"<?= navClass('zapatos', $activeNav) ?>>Zapatos</a>
        <a href="/proyecto/productos.php?cat=accesorios"<?= navClass('accesorios', $activeNav) ?>>Accesorios</a>
